...
//                 // Habilitar dual source si está disponible
//                 this.oandaAPI.enableDualSource();
    ...
    generateFinalVerdict(combinedAnalysis) {
        try {
            ...
            const verdict = {
                ...
                timestamp: new Date().toISOString(),
                basedOnRealData: investingData?.isReal || false,
                // 🔥 Agregar información de dual-source
                dataQuality: {
            ...
            console.log(`🎯 VEREDICTO FINAL (DUAL-SOURCE):`, verdict);
            return verdict;
